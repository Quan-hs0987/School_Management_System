...
class StudentAddFeesModel extends Model
{
    ...
    static public function getRecord(){
        $return = self::select(
                ...
                'student.name as student_name_first', 
                'student.last_name as student_name_last'
            )
    ...
    static public function getTotalTodayFees(){
        return self::where('student_add_fees.is_payment', '=', 1)
                   ->whereDate('student_add_fees.created_at', Carbon::today())
                   ->sum('student_add_fees.paid_amount');
    }
    ...
    static public function getTotalPaidAmountStudentParent($student_id){
        return self::where('student_add_fees.is_payment', '=', 1)
