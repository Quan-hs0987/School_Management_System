            ...
            <div class="container-fluid">
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6" style="text-align: right;">
                        <a href="{{ url('admin/parent/create') }}" class="btn btn-primary">Add new Parent</a>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
        </section>
                                        ...
                                        @foreach ($getRecord as $item)
                                            <tr>
                                                ...
                                                <td style="min-width: 330px">
                                                    <a href="{{ url('admin/parent/edit/' . $item->id) }}"
                                                        class="btn btn-primary btn-sm">Edit</a>
                                                    <a href="{{ url('admin/parent/delete/' . $item->id) }}"
                                                        class="btn btn-danger btn-sm">Delete</a>
                                                    <a href="{{ url('admin/parent/my-student/' . $item->id) }}"
