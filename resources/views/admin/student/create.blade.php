                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="text" class="form-control" name="admission_number"
                                                value="{{ old('admission_number') }}" required placeholder="Last Name">
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="text" class="form-control" name="roll_number"
                                                value="{{ old('roll_number') }}" required placeholder="Last Name">
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <select class="form-control" required name="class_id">
                                                ...
                                                @foreach ($getClass as $item)
                                                    <option {{ old('class_id') == $item->id ? 'selected' : '' }}
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="date" class="form-control" name="admission_date"
                                                value="{{ old('admission_date') }}" required placeholder="Admission Date">
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="text" class="form-control" name="blood_group"
                                                value="{{ old('blood_group') }}" required placeholder="Blood Group">
                                            <div style="color: red">{{ $errors->first('blood_group') }}</div>
                                        </div>
                                        <div class="form-group col-md-6">
                                            <label> Height <span style="color: red"></span></label>
                                            <input type="text" class="form-control" name="height"
                                                value="{{ old('height') }}" required placeholder="Height">
